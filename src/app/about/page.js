          ...
          {developers.map((dev, index) => (
            ...
            >
              <CardContent className="pt-6 text-center">
                ...
                <h3 className="font-semibold text-lg mt-4 text-white">{dev.name}</h3>
