...
export default function DevelopersSection() {
  ...
  return (
    <section className="bg-purple-50 px-4 py-16 md:py-24">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-secondary/20 text-secondary-foreground text-xl font-medium">
            ...
            <h1 className="text-purple-900">Meet the Team</h1>
          </div>
          <h2 className="text-4xl font-bold mt-4 text-purple-700">Our Developers</h2>
          <p className="max-w-2xl mx-auto mt-2 text-purple-700">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {developers.map((dev, index) => (
            <Card key={index} className="bg-gradient-to-br from-pink-100 border-2 hover:border-purple-500 cursor-pointer transition">
              <CardContent className="pt-6 text-center">
                {dev.image ? (
                  ...
                  <img
                    src={dev.image}
                    alt={dev.name}
                    className="w-20 h-20 rounded-full object-cover mx-auto border-purple-300 border-3"
                  />
                ) : (
                ...
                <h3 className="font-semibold text-lg mt-4">{dev.name}</h3>
