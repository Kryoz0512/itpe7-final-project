    ...
    return (
        ...
        >
            {Games.map((game, index) => (
                ...
                >
                    <Link href={game.link}>
                        <Card className="group relative w-72 h-80 bg-gradient-to-br from-purple-700/30 to-pink-700/30 border border-white/20 backdrop-blur-md overflow-hidden rounded-2xl shadow-xl hover:shadow-pink-500/70 transition-all duration-500 m-10">
